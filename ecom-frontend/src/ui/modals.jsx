      ...
      <div className='fixed inset-0 overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
          <div className='pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'>
            <DialogPanel
              transition
              className='pointer-events-auto relative w-screen max-w-[900px] transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700'
            >
              <div className='flex h-full flex-col bg-white shadow-xl'>
                <div className='px-4 sm:px-6 pt-4 border-b flex items-center justify-between gap-3'>
                  ...
                  >
                    ...
                    <RxCross1 className='text-slate-800 text-xl' />
                  </button>
                </div>
...
export function DeleteModal({ open, setOpen, title, onDeleteHandler, loader }) {
  return (
